...
static menu_entry e_menu_main[] =
{
	...
	mee_label     (""),
	mee_label     (""),
	mee_handler_id("重命名游戏",        MA_MAIN_RESUME_GAME, main_menu_handler),
	mee_handler_id("保存状态",         MA_MAIN_SAVE_STATE,  main_menu_handler),
	mee_handler_id("加载状态",         MA_MAIN_LOAD_STATE,  main_menu_handler),
	mee_handler_id("重置游戏",         MA_MAIN_RESET_GAME,  main_menu_handler),
	mee_handler_id("更换CD",          MA_MAIN_CHANGE_CD,   main_menu_handler),
	mee_cust_s_h  ("Storyware 页面",     MA_MAIN_PICO_PAGE, 0,mh_picopage, mgn_picopage, NULL),
	mee_handler_id("补丁 / GameGenie",MA_MAIN_PATCHES,     main_menu_handler),
	mee_handler_id("加载新的游戏",      MA_MAIN_LOAD_ROM,    main_menu_handler),
	mee_handler   ("更改设置",                          menu_loop_options),
	mee_cust_s_h  ("保存为全局选项",MA_OPT_SAVECFG, 0,   mh_saveloadcfg, mgn_saveloadcfg, NULL),
	mee_cust_s_h  ("保存游戏设置",  MA_OPT_SAVECFG_GAME, 0, mh_saveloadcfg, mgn_saveloadcfg, h_saveload),
	mee_cust_s_h  ("加载游戏设置",  MA_OPT_LOADCFG, 0,   mh_saveloadcfg, mgn_saveloadcfg, h_saveload),
	mee_handler_id("贡献",            MA_MAIN_CREDITS,     main_menu_handler),
...
static menu_entry e_menu_tray[] =
{
	...
	mee_label  (""),
	mee_label  (""),
	mee_handler("加载光盘镜像",  mh_tray_load_cd),
	mee_handler("未插入任何东西", mh_tray_nothing),
	mee_end,
};
